                ...
                $display=mysql_query($select_sql) or die("Error! ".mysql_error());
                   ...
                   <br>
                    ...
                    <ul class='list-group'>
                     ...
                     <li class='list-group-item list-group-item-default'>Quantity<span class='badge'>".$row["product_quantity"]." kg</span></li><br>
                     <li class='list-group-item list-group-item-default'>Status<span class='badge'>$pro_status</span></li>
                        ...
                        <p class='form-contral'> See more </p><a href='details1.php?prd_id=$prod_id''><button class='btn btn-default btn-md'>Details</button></a>
