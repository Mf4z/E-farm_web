                 ...
                 <div class="row">
                   ...
                   <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php
                      ...
                      $sql="SELECT *FROM product WHERE username='$userid' ORDER BY RAND() LIMIT 0,9";
                      ...
                      <tr  class='odd-gradex'>
                        ...
                        <td><a href='updateproduct.php?proid=$prod_id'>Update</a></td>
                      
                        <td><a href='myproducts.php?proid=$prod_id'><span class='fa fa-trash-o'> Delete</span></a></td>
